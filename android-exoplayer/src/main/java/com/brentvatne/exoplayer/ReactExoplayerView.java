    ...
    private void initializePlayer() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                // Working example:
                /*DataSource.Factory dataSourceFactory =
                        new DefaultDataSourceFactory(ReactExoplayerView.this.themedReactContext, Util.getUserAgent(ReactExoplayerView.this.themedReactContext, "Test App"));
                ...
                player = new SimpleExoPlayer.Builder(ReactExoplayerView.this.themedReactContext).setMediaSourceFactory(mediaSourceFactory).build();
                exoPlayerView.setPlayer(player);
                adsLoader.setPlayer(player);
        ...
        builder.setAdEventListener(new AdEvent.AdEventListener() {
            ...
            public void onAdEvent(AdEvent adEvent) {
                ...
                if(adEvent.getType() == AdEvent.AdEventType.CONTENT_RESUME_REQUESTED) {
                    eventEmitter.adEventInControl(false);
                } else if(adEvent.getType() == AdEvent.AdEventType.CONTENT_PAUSE_REQUESTED) {
                    eventEmitter.adEventInControl(true);
                } else {
